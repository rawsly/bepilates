...
const Footer = () => {
  ...
  const detailsItemsData = [
    ...
    },
    {
      key: "address",
      text:
        "Bahçeşehir 2. Ks. Avni Akyol Bulvarı Loca B 22 Başakşehir/İstanbul",
    },
  ]
            ...
            <div className="col-12 col-sm-6 col-lg-3">
              ...
              <div className="footer-items">
                ...
                <a className="navbar-brand" href="#">
                  {footerLogo && <Img fixed={footerLogo} className="logo" />}
                </a>
                {/* Social Icons */}
            ...
            <div className="col-12">
              ...
              <div className="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                ...
                <div className="copyright-right text-white-50">
                  Designed with <i className="icofont-heart-alt" /> by{" "}
                  <a className="text-white-50" href="http://rawsly.com">
                    rawsly
                  </a>
                </div>
              </div>
